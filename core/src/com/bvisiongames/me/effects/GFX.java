...
public class GFX {
    ...
    //tmp variables
    private static Vector2[] tmpPoints = new Vector2[]{
            new Vector2(0, 0),
            new Vector2(0, 0)
    };
    ...
    public static void drawChainLightningRandomBetweenPoints(SpriteBatch batch, Vector2 startPos, Vector2 endPointOne, Vector2 endPointTwo) {
        tmpPoints[1] = startPos;
        tmpPoints[0].set(MathUtils.random(endPointOne.x, endPointTwo.x), MathUtils.random(endPointOne.y, endPointTwo.y));
        drawChainLightning(batch, tmpPoints, thickness, numberOfBolts, colourOne, colourTwo);
    }
    ...
    public static void drawChainLightningRandomBetweenPoints(SpriteBatch batch, Vector2 startPos, Vector2 endPointOne, Vector2 endPointTwo, float thickness, int numberOfBolts, Color colourA, Color colourB) {
        tmpPoints[1] = startPos;
        tmpPoints[0].set(MathUtils.random(endPointOne.x, endPointTwo.x), MathUtils.random(endPointOne.y, endPointTwo.y));
        drawChainLightning(batch, tmpPoints, thickness, numberOfBolts, colourA, colourB);
    }
